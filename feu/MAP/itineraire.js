...
var mymap = L.map('mapid').setView([45.75, 4.85], 12); //création de la map avec les coordonnées de l'agglo de Lyon
    L.tileLayer('https://api.mapbox.com/styles/v1/{id}/tiles/{z}/{x}/{y}?access_token={accessToken}', {
        ...
        tileSize: 512,
        zoomOffset: -1,
        accessToken: 'pk.eyJ1IjoiZW1pbGVhcmd0ZSIsImEiOiJja2ppYXN3YTgwMWxhMzhzN2d5N211M3I0In0.MoGt06oEn_yTUOmdfIa_aA' //token de connexion à Mapbox
    }).addTo(mymap);
    ...
    xmlhttp.onreadystatechange = () => {
        ...
        if(xmlhttp.readyState = 4){ // on a passé les 4 etapes 
            ...
            if(xmlhttp.status = 200) {
                ...
                feux = donnees.feux
                donnees.feux.forEach(feu => { //on boucle sur les donnees
                ...
                marker.bindPopup("<b>Feu ID : " + feu.id + "</b> <br> Intensite : " + feu.intensite + "<br> Longitude :" + feu.lon + "<br> Latitude :" + feu.lat) // popup lorsqu'on clique sur un feu
                })
